...
CREATE TABLE `telefone` (
  ...
  `cod_tbl_lista` int(11) DEFAULT NULL,
  PRIMARY KEY (`cod_telefone`),
  KEY `cod_tbl_lista` (`cod_tbl_lista`),
  CONSTRAINT `telefone_ibfk_1` FOREIGN KEY (`cod_tbl_lista`) REFERENCES `tbl_lista` (`cod_lista`)
...
INSERT INTO `telefone` VALUES (2,'11111111111','22222222222','13333333333',4);
